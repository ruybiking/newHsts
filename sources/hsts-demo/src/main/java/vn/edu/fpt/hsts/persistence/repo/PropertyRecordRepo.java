...
public interface PropertyRecordRepo extends JpaRepository<PropertyRecord, Integer> {
    ...
    @Query(value = "SELECT * FROM propertyrecord WHERE medicalRecordDataId = :medicalRecordDataId", nativeQuery = true)
    public List<PropertyRecord> findAllPropertyRecordByMrd(@Param(value = "medicalRecordDataId") final int medicalRecordDataId);
